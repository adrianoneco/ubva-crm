        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-1">
            <button
              ...
              className="p-2 hover:bg-secondary-100 rounded-xl transition-colors text-secondary-600"
            >
            ...
            <button
              ...
              className={`
                ...
                ${day && day.toDateString() === selectedDate.toDateString()
                  ? 'bg-gradient-to-br from-primary-500 to-primary-600 text-white font-semibold shadow-lg shadow-primary-500/30'
                  : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300'
                }
                ${day && day.toDateString() === new Date().toDateString() && day.toDateString() !== selectedDate.toDateString()
          ...
          <>
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${available
                        ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 shadow-sm'
                        : booked
            ...
            <div className="mt-6 flex items-center justify-center space-x-6 text-sm">
              <div className="flex items-center space-x-2">
                <div className=\"w-4 h-4 rounded-lg border-2 border-primary-500 bg-primary-50 dark:bg-primary-900/20\"></div>
                <span className=\"text-gray-600 dark:text-gray-400\">Disponível</span>
              </div>
              <div className=\"flex items-center space-x-2\">
                <div className=\"w-4 h-4 rounded-lg border-2 border-red-500 bg-red-50 dark:bg-red-900/20\"></div>
              ...
              <div className=\"flex items-center space-x-2\">
                ...
                <span className=\"text-gray-600 dark:text-gray-400\">Não marcado</span>
              </div>
            </div>
          </>
        )}
