...
export default function KanbanCard({ user, onDelete, isDragging = false }: KanbanCardProps) {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`bg-white dark:bg-gray-700 rounded-xl p-4 shadow-sm hover:shadow-lg transition-all cursor-move border border-gray-200 dark:border-gray-600 hover:border-primary-400 dark:hover:border-primary-500 ${
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center space-x-3">
          {user.avatar ? (
            ...
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-white font-semibold text-sm shadow-lg shadow-primary-400/30">
